...
@section('content')
    ...
    <section class="video-wrapper video section-padding bg-img bg-fixed" data-overlay-dark="4"
        data-background="{{ asset('assets/images/slider/1.jpg') }}">
        <div class="container">
            <div class="row">
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{ asset('assets/images/team/1.jpg') }}" alt="">
                                    </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            class="w-11 h-11">
                        ...
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{ asset('assets/images/team/4.jpg') }}"
                                            alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            class="w-11 h-11">
                        ...
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{ asset('assets/images/team/6.jpg') }}"
                                            alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            class="w-11 h-11">
    ...
    <section class="team section-padding">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="{{ asset('assets/images/team/1.jpg') }}" class="img-fluid"
                                alt="">
                        ...
                        <div class="item"> <img src="{{ asset('assets/images/team/4.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="info">
                                <div class="butn icon-bg">
                        ...
                        <div class="item"> <img src="{{ asset('assets/images/team/5.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="info">
                                <div class="butn icon-bg">
                        ...
                        <div class="item"> <img src="{{ asset('assets/images/team/2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
                        ...
                        <div class="item"> <img src="{{ asset('assets/images/team/6.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
                        ...
                        <div class="item"> <img src="{{ asset('assets/images/team/3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
    ...
    <section class="lets-talk bg-img bg-fixed section-padding" data-overlay-dark="5"
        data-background="{{ asset('assets/images/slider/3.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h6>Rent Your Car</h6>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/1.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/2.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/3.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/4.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/5.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/6.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/7.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('assets/images/clients/8.png') }}" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
