            ...
            <div class="card border-0 shadow" style="background-color: #fac0b9">
                <div class="card-header d-sm-flex flex-row align-items-center flex-0">
                    <div class="d-block mb-3 mb-sm-0">
                        ...
                        <h2 class="fs-3 fw-extrabold">{{ $totalearned }}</h2>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Total Cars</h2>
                                <h3 class="mb-1">{{ $totalcar + 0 }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Total Cars</h2>
                                <h3 class="fw-extrabold mb-2">{{ $totalcar + 0 }}</h3>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Total Available car</h2>
                                <h3 class="mb-1">{{ $totalavailablecar }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Total Available car</h2>
                                <h3 class="fw-extrabold mb-2">{{ $totalavailablecar }}</h3>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5"> Total Rentals</h2>
                                <h3 class="mb-1">{{ $totalrentals }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0"> Total Rentals</h2>
                                <h3 class="fw-extrabold mb-2">{{ $totalrentals }}</h3>
                            </div>
