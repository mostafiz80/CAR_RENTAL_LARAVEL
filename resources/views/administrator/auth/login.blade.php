...
<head>
    ...
    <!-- Vendor JS -->
    <script src="/admin/assets/js/on-screen.umd.min.js"></script>

    <!-- Slider -->
    <script src="/admin/assets/js/nouislider.min.js"></script>

    <!-- Smooth scroll -->
    <script src="/admin/assets/js/smooth-scroll.polyfills.min.js"></script>
    ...
    <script src="/admin/assets/js/chartist-plugin-tooltip.min.js"></script>
                        ...
                        <form action="{{ route('login') }}" method="POST" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control"  value="{{ old('email') }}" placeholder="example@company.com"
